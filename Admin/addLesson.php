...
include('../dbConnection.php');
 ...
 if(isset($_REQUEST['lessonSubmitBtn'])){
  ...
  if(($_REQUEST['lesson_name'] == "") || ($_REQUEST['lesson_desc'] == "") ||  ($_REQUEST['course_id'] == "") || ($_REQUEST['course_name'] == "")){
   ...
   $lesson_references = $_FILES['lesson_references']['name'];
   $lesson_references_temp = $_FILES['lesson_references']['tmp_name'];
   $reference_folder = '../lessonpdf/'.$lesson_references;
   move_uploaded_file($lesson_references_temp, $reference_folder);

    $sql = "INSERT INTO lesson (lesson_name, lesson_desc, lesson_link,lesson_references, course_id, course_name) VALUES ('$lesson_name', '$lesson_desc','$link_folder','$reference_folder', '$course_id', '$course_name')";
